...
const WorkCards = ({ icon, title, subtitle }) => {
  ...
  return (
    <div className={styles.container}>
        <div>
            {icon === "video" ? <svg width="124" height="100" viewBox="0 0 124 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg> : icon === "wand" ? <svg width="124" height="124" viewBox="0 0 124 124" fill="none" xmlns="http://www.w3.org/2000/svg">
